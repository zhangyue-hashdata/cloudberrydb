...
ifdef XGETTEXT
XGETTEXT += -ctranslator --copyright-holder='Cloudberry Project' --msgid-bugs-address=dev@cloudberry.apache.org --no-wrap --sort-by-file --package-name='$(CATALOG_NAME) (Cloudberry)' --package-version='$(MAJORVERSION)'
endif
