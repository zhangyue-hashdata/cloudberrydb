...
select mkdir('/code/cbdb_src/contrib/pax_storage/src/test/isolation2/testtablespace/rg_io_limit_ts_1') from gp_dist_random('gp_id') intersect select mkdir('/code/cbdb_src/contrib/pax_storage/src/test/isolation2/testtablespace/rg_io_limit_ts_1') from gp_id;

CREATE TABLESPACE rg_io_limit_ts_1 LOCATION '/code/cbdb_src/contrib/pax_storage/src/test/isolation2/testtablespace/rg_io_limit_ts_1';
