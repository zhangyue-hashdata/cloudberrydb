...
CREATE TABLE reindex_crtabforalter_part_pax_btree (id int, date date, amt decimal(10,2))
DISTRIBUTED BY (id)
...
2&: REINDEX TABLE  reindex_crtabforalter_part_pax_btree;
3&: alter table reindex_crtabforalter_part_pax_btree drop column amt;
1: COMMIT;
2<:
3<:
