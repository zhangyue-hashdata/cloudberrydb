...
! rm -rf '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/testtablespace/local_directory_table_mixed/';
! mkdir -p '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/testtablespace/local_directory_table_mixed/';
DROP TABLESPACE IF EXISTS directory_tblspc;
CREATE TABLESPACE directory_tblspc LOCATION '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/testtablespace/local_directory_table_mixed/';
...
1: COPY BINARY dir_table1 FROM '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/data/nation.csv' 'nation1';
2: COPY BINARY dir_table2 FROM '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/data/nation.csv' 'nation2';
3: COPY BINARY dir_table1 FROM '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/data/nation.csv' 'nation3';
4: COPY BINARY dir_table2 FROM '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/data/nation.csv' 'nation4';

-- Test copy binary from the same directory table in parallel session is allowed
1: BEGIN;
2: BEGIN;
1: COPY BINARY dir_table1 FROM '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/data/nation.csv' 'nation5';
2: COPY BINARY dir_table1 FROM '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/data/nation.csv' 'nation6';
1: COMMIT;
2: COMMIT;
...
1: BEGIN;
2: BEGIN;
1: COPY BINARY dir_table2 FROM '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/data/nation.csv' 'nation5';
...
1: BEGIN;
2: BEGIN;
1: COPY BINARY dir_table2 FROM '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/data/nation.csv' 'nation6';
...
1: BEGIN;
2: BEGIN;
1: COPY BINARY dir_table1 FROM '/code/cloudberry-pax-opensource/contrib/pax_storage/src/test/isolation2/data/nation.csv' 'nation7';
